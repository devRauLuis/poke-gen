...
function Form(props) {
  return (
    <div>
      <div className='form-container flex flex-col justify-between h-screen shadow-2xl w-full bg-white rounded shadow-xl'>
        <div className={'w-full'}>
          <div className='bg-red-600 grid place-items-center px-2 py-10'>
        ...
        <button
          className={
            'appearance-none border-2 border-gray-700 focus:outline-none text-2xl text-gray-700 block ml-auto h-12 w-12 rounded-full mb-10 mr-3 md:mb-2 transition duration-150 hover:border-blue-500 hover:text-blue-500 transform hover:scale-95'
          }
